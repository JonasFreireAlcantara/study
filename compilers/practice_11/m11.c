...
#ifdef FACTORIAL
static int entrada[N] = {Y, AP, AP, B, AP, S, AP, S, AP, C, AP, C, I, 1, FP, eq, FP, AP, K, 1, FP, FP, FP, FP, AP, C, AP, B, C, AP, B, AP, S, I, FP, AP, C, AP, B, B, I, FP, AP, C, AP, C, I, 1, FP, sub, FP, FP, FP, FP, mul, FP, FP, 5, fim_string};
#else
static int entrada[N] = {Y, AP, B, AP, S, AP, S, AP, C, AP, C, I, 2, FP, lt, FP, I, FP, FP, AP, F, C, AP, S, AP, F, D, I, AP, C, AP, C, I, 2, FP, sub, FP, FP, AP, F, B, I, AP, C, AP, C, I, 1, FP, sub, FP, FP, FP, add, FP, FP, 5, fim_string};
#endif
...
#ifdef FACTORIAL
    printf("\nComputation of factorial completed !\n");
#else
    printf("\nComputation of fibonacci completed !\n");
#endif
