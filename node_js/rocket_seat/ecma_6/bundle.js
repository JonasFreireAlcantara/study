...
function (_Usuario) {
  ...
  function Admin(email, senha) {
    ...
    _get(_getPrototypeOf(Admin.prototype), "setUserAsAdmin", _assertThisInitialized(_this)).call(_assertThisInitialized(_this));
...
console.log(idades);
var empregadosRocketSeat = usuarios.filter(function (usuarios) {
  return usuarios.idade > 18 && usuarios.empresa === 'Rocketseat';
});
console.log(empregadosRocketSeat);
var empregadosGoogle = usuarios.find(function (usuarios) {
  return usuarios.empresa === 'Google';
});
console.log(empregadosGoogle);
var empregadosTwice = usuarios.map(function (usuarios) {
  return _objectSpread({}, usuarios, {
    idade: usuarios.idade * 2
  });
});
console.log(empregadosTwice.filter(function (usuarios) {
