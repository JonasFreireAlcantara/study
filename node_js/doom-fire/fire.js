...
function updateFireIntensityPerPixel(currentPixelIndex) {
    ...
    switch(sentido) {
        case 0:
            firePixelsArray[currentPixelIndex - decay] = newFireIntensity; // left
            break;
        case 1:
            firePixelsArray[currentPixelIndex] = newFireIntensity; // no wind
            break;
        case 2:
            firePixelsArray[currentPixelIndex + decay] = newFireIntensity; // right
            break;
    }
}
...
function increaseFireSource() {
    ...
    for (let column = 0; column < fireWidth; column++) {
        const pixelIndex = (overflowPixelIndex - fireWidth) + column;
        const currentFireIntensity = firePixelsArray
    }
}
